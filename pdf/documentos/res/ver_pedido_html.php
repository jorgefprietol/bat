...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select sum(detalle_pedido.cantidad) as catidadtotal, detalle_pedido.codigo_producto, detalle_pedido.numero_pedido, productos.nombreProducto, detalle_pedido.precio_unitario, productos.iva from productos, detalle_pedido where productos.idProducto=detalle_pedido.codigo_producto and detalle_pedido.numero_pedido='".$numero_pedido."' group by detalle_pedido.codigo_producto, detalle_pedido.numero_pedido, productos.nombreProducto, detalle_pedido.precio_unitario, productos.iva");
