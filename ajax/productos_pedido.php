<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $sWhere = " WHERE listalinea.codigoLinea=productos.codigoLinea and productos.estadoProd=1 and productos.facturar=1 and productos.web=1 and productos.promocion=1";
		if ( $_GET['q'] != "" )
		{
			$sWhere = "WHERE (";
		...
		$sql="SELECT *, listalinea.nombreLinea FROM  $sTable $sWhere LIMIT $offset,$per_page";
			...
			<div class="table-responsive">
			  <table class="table">
				...
				<tr>
					...
					<?php
					 echo "no".paginate($reload, $page, $total_pages, $adjacents);
					?></span></td>
				</tr>
			  </table>
			</div>
