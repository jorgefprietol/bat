...
##   $ docker build -t php-for-jorgeprieto-baterias-ecuador-pedidos .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-jorgeprieto-baterias-ecuador-pedidos
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="zgv4q78" \
    STACKSMITH_STACK_NAME="PHP for jorgeprieto/baterias-ecuador-pedidos" \
