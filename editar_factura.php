<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Factura | Baterias _ Pedidos";
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="estado_factura" readonly name="estado_factura" value="Enviado">
									<option value="1" <?php if ($estado_factura==1){echo "selected";}?>>Enviado</option>
								</select>
							</div>
						</div>
